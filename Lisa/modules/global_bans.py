...
import Lisa.modules.sql.global_bans_sql as sql
from Lisa import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Lisa.modules.helper_funcs.misc import send_to_list
from Lisa.modules.sql.users_sql import get_user_com_chats
