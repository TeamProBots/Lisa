...
from Lisa import BOT_ID
from Lisa import DRAGONS as DEVS
from Lisa import OWNER_ID
from Lisa import telethn as Mukesh
from Lisa.events import Mukeshinline
from Lisa.events import register as Mukeshbot
from Lisa.modules.no_sql import fsub_db as db
...
*ғᴏʀᴄᴇ ꜱᴜʙꜱᴄʀɪʙᴇ:*
   ...
   •➥ *ꜱᴇᴛᴜᴘ*
   •➥ [ᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀꜱ ᴀᴅᴍɪɴ](https://t.me/LisaPrBot?startgroup=new)
   •➥ [ᴀᴅᴅ ᴍᴇ ɪɴ your ᴄʜᴀɴɴᴇʟ ᴀꜱ ᴀᴅᴍɪɴ](https://t.me/LisaPrBot?startchannel=new)
 
    *ᴄᴏᴍᴍᴍᴀɴᴅꜱ*
   •➥ /fsub channel username - ᴛᴏ ᴛᴜʀɴ ᴏɴ ᴀɴᴅ sᴇᴛᴜᴘ ᴛʜᴇ ᴄʜᴀɴɴᴇʟ.
   •➥ /fsub off - ᴛᴏ ᴛᴜʀɴ ᴏғғ ғᴏʀᴄᴇꜱᴜʙꜱᴄʀɪʙᴇ..
