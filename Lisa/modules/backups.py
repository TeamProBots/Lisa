...
# from Lisa.modules.sql import warns_sql as warnssql
import Lisa.modules.sql.blacklist_sql as blacklistsql

# from Lisa.modules.sql import cust_filters_sql as filtersql
# import Lisa.modules.sql.welcome_sql as welcsql
import Lisa.modules.sql.locks_sql as locksql
import Lisa.modules.sql.notes_sql as sql

# from Lisa.modules.rules import get_rules
import Lisa.modules.sql.rules_sql as rulessql
from Lisa import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from Lisa.__main__ import DATA_IMPORT
from Lisa.modules.connection import connected
from Lisa.modules.helper_funcs.alternate import typing_action
from Lisa.modules.helper_funcs.chat_status import user_admin
from Lisa.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("Lisa{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Lisa{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Lisa-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Lisa{}.backup".format(chat_id))  # Cleaning file
