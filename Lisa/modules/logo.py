...
from Lisa.modules.nightmode import button_row
from Lisa import BOT_USERNAME, OWNER_ID,BOT_NAME, SUPPORT_CHAT, telethn
from Lisa.events import register
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./Lisa/resources/fonts/*")
