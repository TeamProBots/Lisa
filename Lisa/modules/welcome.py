...
import Lisa
import Lisa.modules.sql.welcome_sql as sql
from Lisa import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Lisa.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Lisa.modules.helper_funcs.msg_types import get_welcome_type
    ...
    for new_mem in new_members:
        ...
        if should_welc:
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Bᴇ ᴄᴏᴏʟ! A ᴍᴇᴍʙᴇʀ ᴏғ ᴛʜᴇ PʀᴏBᴏᴛs Jᴜsᴛ Jᴏɪɴᴇᴅ.",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
