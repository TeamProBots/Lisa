...
import Lisa.modules.no_sql.users_db as sql
from Lisa import (
    BOT_NAME,
    BOT_USERNAME,
    LOGGER,
...
from Lisa.modules import ALL_MODULES
from Lisa.modules.helper_funcs.chat_status import is_user_admin
from Lisa.modules.helper_funcs.misc import paginate_modules
...
ᴛʜᴇ ᴍᴏsᴛ ᴩᴏᴡᴇʀғᴜʟ ɢʀᴏᴜᴩ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ᴡɪᴛʜ sᴏᴍᴇ ᴀᴡᴇsᴏᴍᴇ ᴀɴᴅ ᴜsᴇғᴜʟ ғᴇᴀᴛᴜʀᴇs.
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Lisa.modules." + module_name)
...
def Lisa_Main_Callback(update: Update, context: CallbackContext):
    query = update.callback_query
...
""",reply_markup=x,
    ...
    Lisa_main_handler = CallbackQueryHandler(
        Lisa_Main_Callback, pattern=r".*_help",run_async=True)
    ...
    dispatcher.add_handler(Lisa_main_handler)
